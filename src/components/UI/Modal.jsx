...
const Modal = ({activeID, setShowModal}) => {
 const portfolio = Portfolios.find(portflio =>portflio.id === activeID);
  ...
  return (
    <div className='w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40'>
        ...
        <div>
            ...
            <p className="text-[15px] leading-7 terxt-smallTextColor">
                {portfolio.description}
            </p>
            <div className="mt-5 flex items-center gap-3 flex-wrap">
                <h4 className="text-heading-color text-[18px] text-[600]">
                    Technologies
                </h4>
            ...
            <a href={portfolio.siteUrl} target='_blanck'>
        ...
        flex items-center justify-center rounded-[3px] leading-0 cursor-pointer">&times;
